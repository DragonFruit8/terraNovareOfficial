  ...
  return (
    <>
      <section id='titleHeader' className="col-lg-12 col-md-12 bg-dark text-white text-center">
        <h1 className="fw-light"><em>Who we are, are change-makers</em></h1>
      </section>
      ...
      <div className="container justify-items-center pt-5 mt-2">
        ...
        <div id='#mission' className="row featurette">
          <h1><em>E-Finity</em></h1>
          <div className="col-md-8">
            <p className="featurette-heading fs-5">E-Finity seeks to promote effective operational functionality in startups, drive philanthropic efforts, and <span className="text-muted"> facilitate community education in propositions based on consensus through local leadership.</span></p>
            <p className="lead">
