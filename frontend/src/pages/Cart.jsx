...
const Cart = () => {
  ...
  if (!cartData || !cartData.items || cartData.items.length === 0) {
    return <div className="container mt-5"><h2 aria-hidden="false" >Your Cart is Empty 🛒</h2></div>;
  }

  return (
    <div className="container mt-5">
    <h2 aria-hidden="false" >Your Cart</h2>
    <div className="row">
        ...
        <div key={item.product_id} className="col-md-4">
          <div className="card">
            ...
            <div className="card-body">
              <h5 aria-hidden="false" className="card-title">{item.name}</h5>
    ...
    <h3 aria-hidden="false" className="mt-4">Total: ${cartSubtotal.toFixed(2)}</h3>
