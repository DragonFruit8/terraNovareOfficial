  ...
  return (
    <>
      ...
      <section id='titleHeader' className="col-lg-12 col-md-12 bg-dark text-white text-center">
        <h1 className="fw-light px-0"><em>Change your perspective, change your life.</em></h1>
      </section>
      <div className="container justify-items-center pt-5 mt-2">
        ...
        <div id='mission' className="row featurette">
          ...
          <div className="col-md-10">
            <p className="featurette-heading fs-4">At Terra’Novare, we are dedicated to creating a harmonious future by blending cutting-edge technology, 
              ...
              practices with innovation. 
               <p className="lead text-muted fs-4"> We believe in fostering a balanced relationship between people, technology, and the planet, where progress and well-being coexist seamlessly. </p></p>
          </div>
        ...
        <div className="row featurette">
          <div className="col-md-10">
            <h2 className="featurette-heading">Become a<span className="text-muted"> Sponsor</span></h2>
            <p className="lead">As a sponsor, you have the opportunity to partner with a brand at the forefront of sustainability and innovation. Your support can help us further our mission to create solutions that benefit the environment and empower individuals. Let’s work together to make a lasting impact.</p>
          </div>
